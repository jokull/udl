...
func TestMoviePath(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			ext:   ".mkv",
			want:  "/media/Movies/Dune Part Two (2024)/Dune Part Two (2024) [WEBDL-1080p].mkv",
		},
		{
			...
			ext:   ".mkv",
			want:  "/data/Movies/Oppenheimer (2023)/Oppenheimer (2023) [Bluray-2160p].mkv",
		},
		{
			...
			ext:   ".mp4",
			want:  "/media/Movies/Mission Impossible (1996)/Mission Impossible (1996) [Bluray-1080p].mp4",
		},
		{
			...
			q:     quality.Unknown,
			ext:   ".avi",
			want:  "/media/Movies/The Matrix (1999)/The Matrix (1999) [Unknown].avi",
		},
	}
...
func TestEpisodePath(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			q:       quality.WEBDL1080p,
			ext:     ".mkv",
			want:    "/media/TV/Severance (2022)/Season 02/Severance - S02E01 - Hello, Ms. Cobel [WEBDL-1080p].mkv",
		},
		{
			...
			q:       quality.HDTV720p,
			ext:     ".mkv",
			want:    "/media/TV/Breaking Bad (2008)/Season 05/Breaking Bad - S05E16 [HDTV-720p].mkv",
		},
		{
			...
			ext:     ".mkv",
			want:    "/data/TV/Star Trek Discovery (2017)/Season 01/Star Trek Discovery - S01E03 - Context Is for Kings [WEBDL-2160p].mkv",
		},
		{
			...
			q:       quality.DVD,
			ext:     ".avi",
			want:    "/media/TV/The Office (2005)/Season 01/The Office - S01E01 - Pilot [DVD].avi",
		},
	}
...
func TestSubtitlePath(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			mediaPath: "/media/TV/Show (2022)/Season 01/Show - S01E01 - Title [WEBDL-1080p].mkv",
			lang:      "en",
			subExt:    ".srt",
			want:      "/media/TV/Show (2022)/Season 01/Show - S01E01 - Title [WEBDL-1080p].en.srt",
		},
		{
			name:      "spanish ASS alongside MP4",
			mediaPath: "/media/Movies/Film (2023)/Film (2023) [Bluray-1080p].mp4",
			lang:      "es",
			subExt:    ".ass",
			want:      "/media/Movies/Film (2023)/Film (2023) [Bluray-1080p].es.ass",
		},
		{
			name:      "forced english subtitle",
			mediaPath: "/media/Movies/Film (2023)/Film (2023) [WEBDL-2160p].mkv",
			lang:      "en",
			subExt:    ".srt",
			want:      "/media/Movies/Film (2023)/Film (2023) [WEBDL-2160p].en.srt",
		},
	}
